...
--
-- Host: localhost:3306
-- Generation Time: May 13, 2024 at 11:53 PM
...
(9, '2024-05-13 00:00:00', 1090000, 2);
...
CREATE TABLE `produk` (
  ...
  `biaya_produksi` int NOT NULL,
  `biaya_jual` int NOT NULL,
  `jumlah` int NOT NULL,
  `jumlah_produksi_perkain` int NOT NULL,
...
(1, 'Daster Rayon', 'All Size', 20000, 50000, 49, 7, '1.5 x 2 meter', 'Active'),
...
--
ALTER TABLE `chat`
  MODIFY `message_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT for table `finance`
--
ALTER TABLE `finance`
  MODIFY `no_urut` int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `pembelian`
  MODIFY `no_pembelian` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `penggajian`
--
ALTER TABLE `penggajian`
  MODIFY `no_penggajian` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `penjahit`
--
ALTER TABLE `penjahit`
  MODIFY `id_penjahit` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `penjahitan`
--
ALTER TABLE `penjahitan`
  MODIFY `no_penjahitan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
